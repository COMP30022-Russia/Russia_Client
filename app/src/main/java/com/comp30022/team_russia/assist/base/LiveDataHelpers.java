...
public class LiveDataHelpers {
    ...
    public static <T1, T2, T3, R> LiveData<R> combineLatest(LiveData<T1> source1, LiveData<T2> source2, LiveData<T3> source3, Function3<T1, T2, T3, R> mapper) {
        SupportMediatorLiveData<R> s = new SupportMediatorLiveData<>();
    ...
    public static <T1, T2, T3, T4, T5, R> LiveData<R> combineLatest(LiveData<T1> source1, LiveData<T2> source2, LiveData<T3> source3, LiveData<T4> source4, LiveData<T5> source5, Function5<T1, T2, T3, T4, T5, R> mapper) {
        SupportMediatorLiveData<R> s = new SupportMediatorLiveData<>();
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> LiveData<R> combineLatest(LiveData<T1> source1, LiveData<T2> source2, LiveData<T3> source3, LiveData<T4> source4, LiveData<T5> source5, LiveData<T6> source6, LiveData<T7> source7, LiveData<T8> source8, Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> mapper) {
        SupportMediatorLiveData<R> s = new SupportMediatorLiveData<>();
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> LiveData<R> combineLatest(LiveData<T1> source1, LiveData<T2> source2, LiveData<T3> source3, LiveData<T4> source4, LiveData<T5> source5, LiveData<T6> source6, LiveData<T7> source7, LiveData<T8> source8, LiveData<T9> source9, Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> mapper) {
        SupportMediatorLiveData<R> s = new SupportMediatorLiveData<>();
